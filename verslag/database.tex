\section{Database}\label{sec:database}
	...
	\subsubsection{Settings}
		...
		De size kolom bestaat uit een integer, deze kan de waardes drie en vier bevatten,
		hierbij stelt de drie een drie bij drie veld voor en de vier een vier bij vier veld.
		De mode kolom bevat de game mode, deze bestaat uit een integer met de waarde nul wat staat voor live beeld,
		of \'e\'en wat staat voor een plaatje uit de gallery.
	...
	\subsubsection{Settings}
		Aangezien de settings tabel maar een entry bevat is het redelijk makkelijk om de settings in te laden,
	...
	\subsubsection{Highscores}
		...
		Het is ook heel simpel selecteren van de juiste entry's doordat er in de query's een where conditie kan worden meegegeven, 
