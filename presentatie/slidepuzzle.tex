...
\begin{document}
	...
	\begin{frame}
		\frametitle{\color{black}{\textbf{SQLite}}}
		Database\\
		Hier een of meer epic plaatjes, met settingsmenu met daarbij de uitleg van sqlite
	\end{frame}

	\begin{frame}
		\frametitle{\color{black}{\textbf{Opbouw van de game}}}
		\begin{itemize}
			\item{Speelveld}
			\item{Image shuffling}
			\item{On touch movement}
			\item{Hints}
		\end{itemize}
	\end{frame}

	\begin{frame}
		\frametitle{\color{black}{\textbf{A* Algoritme}}}
			\begin{itemize}
				\item{Alle mogelijkheden afgaan}
				\item{Kortste oplossing geven}
			\end{itemize}
	\end{frame}

	\begin{frame}
		\frametitle{\color{black}{\textbf{Live demo}}}
		\begin{center}
			\textbf{Live Demo}
		\end{center}
	\end{frame}
